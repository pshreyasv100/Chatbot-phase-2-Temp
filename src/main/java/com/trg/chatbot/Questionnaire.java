...
public class Questionnaire {
  ...
  public String generateQuestionFromOptions(List<String> options, String propertyBeingAsked) {
    ...
    question.append("we have " + options.size() + " " + propertyBeingAsked
        + " to offer , which one do you want?\n");
  ...
  public List<String> setOptionList(List<PMS> availabList, String property) {
    ...
    final Set<String> setOfOptions = new HashSet<>();
    ...
    for (final String item : setOfOptions) {
      result.add(item);
    }
    return result;
